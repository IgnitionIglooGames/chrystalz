package studio.ignitionigloogames.chrystalz.battle.window.turn;
...
import studio.ignitionigloogames.chrystalz.creatures.monsters.AbstractMonster;
...
public class WindowTurnBattleLogic extends AbstractBattle {
    ...
    public final void battleDone() {
        ...
        final GameLogicManager gm = Chrystalz.getApplication().getGameManager();
        gm.showOutput();
        gm.redrawDungeon();
    }
