 ...
 */
package studio.ignitionigloogames.chrystalz.creatures.faiths;
...
import studio.ignitionigloogames.chrystalz.datamanagers.FaithDataManager;
    ...
    static synchronized void initFaiths() {
        if (!FaithConstants.INITED) {
            try {
                ...
                Chrystalz.getErrorLogger().logError(ioe);
            }
        }
    }
}
