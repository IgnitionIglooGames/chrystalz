...
public class StatConstants {
    ...
    public static final int STAT_LUCK = 4;
    public static final int STAT_CURRENT_HP = 5;
    static final int STAT_GOLD = 6;
    public static final int STAT_LEVEL = 7;
    public static final int STAT_ATTACKS_PER_ROUND = 8;
    static final int STAT_LOAD = 9;
    public static final int STAT_MAXIMUM_HP = 10;
    public static final int STAT_ATTACK = 11;
    public static final int STAT_DEFENSE = 12;
    static final int STAT_SPEED = 13;
    public static final int STAT_HIT = 14;
    public static final int STAT_EVADE = 15;
    static final int STAT_CAPACITY = 16;
    static final int STAT_MAX_LEVEL = 17;
    static final int MAX_STORED_STATS = 10;
    public static final int MAX_DISPLAY_STATS = 18;
